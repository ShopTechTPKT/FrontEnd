        ...
        <div className="mb-12 text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex justify-center gap-4 h-12">
            ...
            <button 
              ...
              className="bg-violet-600 hover:bg-violet-700 px-6 py-2 rounded-xl text-white font-medium cursor-pointer transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
