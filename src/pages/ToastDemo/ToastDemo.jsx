...
const ToastDemo = () => {
  ...
  const handleShowWarning = () => {
    showWarning('Cảnh báo! Bạn có chắc muốn tiếp tục?', 5000, 'top-right');
  };
      ...
      <div className="max-w-6xl mx-auto px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-sm text-rose-200/80">Show error toast</p>
              </div>
            </button>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-green-100">
            <div className="text-3xl mb-3">UI</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-blue-100">
            <div className="text-3xl mb-3">FX</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-pink-100">
            <div className="text-3xl mb-3">POS</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-amber-100">
            <div className="text-3xl mb-3">STK</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-lg border-2 border-cyan-100">
            <div className="text-3xl mb-3">ACT</div>
