  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 py-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-indigo-50 rounded-lg p-4 border-2 border-indigo-200">
              <p className="font-semibold text-indigo-700">{t('nav.home')}</p>
            </div>
            <div className="bg-indigo-50 rounded-lg p-4 border-2 border-indigo-200">
              <p className="font-semibold text-indigo-700">{t('nav.products')}</p>
            </div>
            <div className="bg-indigo-50 rounded-lg p-4 border-2 border-indigo-200">
              <p className="font-semibold text-indigo-700">{t('nav.brands')}</p>
            </div>
            <div className="bg-indigo-50 rounded-lg p-4 border-2 border-indigo-200">
              <p className="font-semibold text-indigo-700">{t('nav.deals')}</p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border-2 border-gray-200 rounded-xl p-6 hover:border-indigo-500 transition-colors">
              ...
              <div className="flex gap-2">
                <button className="flex-1 bg-indigo-700 text-white rounded-lg py-2 font-semibold hover:bg-indigo-800 transition-colors">
                  {t('product.addToCart')}
                </button>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex justify-between items-center p-4 bg-indigo-100 rounded-lg border-2 border-indigo-300">
              <span className="font-semibold text-indigo-800">{t('cart.total')}:</span>
              <span className="font-bold text-2xl text-indigo-800">$3,049.00</span>
            </div>
          </div>
          <button className="w-full bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-xl py-4 font-bold text-lg hover:shadow-xl transition-all">
            {t('cart.checkout')} 🚀
          </button>
        </div>
        ...
        {/* Instructions */}
        <div className="mt-12 bg-gradient-to-r from-indigo-100 to-blue-100 rounded-2xl p-8 border-2 border-indigo-300">
